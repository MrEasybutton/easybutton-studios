...
const Projects = () => {
    ...
    const Projects = [
        {
            title: 'PSEUDOMENTO',
            description: 'PSEUDOMENTO is my upcoming debut psychological horror game. Play as a dementia-stricken soul traversing limbo in a bid for their memories.',
            status: 'in DEV',
            year: '2025 (tentative)',
            url: 'https://easybutton-studios.itch.io/pseudomento'
        },
        {
            title: 'kOSeki',
            description: 'From-scratch x86 operating system, themed after my kamioshi Koseki Bijou! Has a GUI, keyboard input, and fun apps!',
            status: 'dev-beta',
            year: '2024-2025',
            url: 'https://github.com/MrEasybutton/kOSeki'
        }
    ];
        ...
        <>
            ...
            >
                <div className="fixed inset-0">
                    <BG_Comp backgroundImage={"PSD_3.png"}/>
                </div>
                <div
